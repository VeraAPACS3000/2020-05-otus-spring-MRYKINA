...
insert into comments (id_books, text_comment) values (1, 'the coolest book!');
insert into comments (id_books, text_comment) values (1, 're-read 10 times!');

insert into comments (id_books, text_comment) values (2, 'Dont read book, but want!');
insert into comments (id_books, text_comment) values (2, 'interesting book!');
insert into comments (id_books, text_comment) values (2, 'I didn''t like!');
insert into comments (id_books, text_comment) values (2, 'well written');
...
insert into comments (id_books, text_comment) values (3, 'Good book, good author, good genre');
...
insert into comments (id_books, text_comment) values (4, 'recommend to all my friends');
insert into comments (id_books, text_comment) values (4, 'book at one time');
