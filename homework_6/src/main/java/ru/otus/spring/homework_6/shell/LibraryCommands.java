package ru.otus.spring.homework_6.shell;
...
public class LibraryCommands {
    ...
    LibraryCommands(LibraryService libraryService) {
    ...
    @ShellMethod(value = "Insert new book. Example i 'new book' 'Lermontov' 'prose'", key = {"ib", "insertBook"})
    public String addNewBook(String nameBook, String nameAuthor, String nameGenre) {
        libraryService.addNewBook(nameBook, nameAuthor, nameGenre);
    ...
    public String update(long id, int status) {
        libraryService.updateStatusBook(id, status);
    ...
    public String findBookById(long id) {
        libraryService.findBookById(id);
    ...
    public String findBookByName(String name) {
        libraryService.findBookByName(name);
    ...
    public String findCommentByIdBook(long id) {
        libraryService.findCommentByIdBook(id);
    ...
    public String findCommentByNameBook(String nameBook) {
        libraryService.findCommentsByNameBook(nameBook);
    ...
    public String updateComment(long id, String newComment) {
        libraryService.updateCommentById(id, newComment);
    ...
    public String addNewComment(String textComments, String nameBook) {
        libraryService.addNewComment(textComments, nameBook);
