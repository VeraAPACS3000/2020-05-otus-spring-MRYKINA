...
public class ChangeLogs {
    ...
    public void initBooks(BooksRepositoriesMongo repository) {
        repository.save(new Book("Vojna i mir TEST", 1, author1, genre1, comment1, comment2));
        repository.save(new Book("VojnaIMirTEST", 1, author1, genre1, comment1, comment2));
        repository.save(new Book("Besi TEST", 1, author2, genre1, comment3));
        repository.save(new Book("Anna Karenina TEST", 1, author1 , genre1, comment4));
        repository.save(new Book("AnnaKareninaTEST", 1, author1 , genre1, comment4));
        repository.save(new Book("Igrok TEST", 0, author2, genre1, comment5));
        repository.save(new Book("IgrokNewTEST", 0, author2, genre1, comment5));
    }
}